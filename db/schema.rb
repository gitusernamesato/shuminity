...
ActiveRecord::Schema.define(version: 2022_08_28_065036) do
  ...
  create_table "chat_messages", force: :cascade do |t|
    ...
    t.index ["id"], name: "index_chat_messages_on_id", unique: true
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["id"], name: "index_favorites_on_id", unique: true
  ...
  create_table "group_users", force: :cascade do |t|
    ...
    t.index ["id"], name: "index_group_users_on_id", unique: true
  ...
  create_table "post_tags", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["id"], name: "index_post_tags_on_id", unique: true
